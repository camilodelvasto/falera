...
if ( !class_exists( 'avia_sc_business' ) )
{
	class avia_sc_business extends aviaShortcodeTemplate
	{
			/**
			...
			function query_entries($params)
			{
                ...
                if(empty($params['blog_type']) || $params['blog_type'] == 'posts') $params['post_type'] = 'business';
